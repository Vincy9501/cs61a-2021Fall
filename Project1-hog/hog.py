...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if which_score(who) - last_score > running_high:
            print(abs(which_score(who) - last_score), \
                      "point(s)! That's a record gain for", 'Player', who,"!")
        return announce_highest(who, which_score(who), max(which_score(who) - last_score, running_high))
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_num = 0
    for i in range(1,11):
        max_score = max_dice(1,dice)
        if max_turn < max_score:
            max_turn = max_score
            max_num = i
    return max_num
    # END PROBLEM 9
...
def picky_piggy_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    return 0 if picky_piggy(opponent_score) >= cutoff else num_rolls# Remove this line once implemented.
    # END PROBLEM 10
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if hog_pile(player_score, opponent_score) != 0 \
        else picky_piggy_strategy(score, opponent_score, cutoff, num_rolls) # Remove this line once implemented.
    # END PROBLEM 11
